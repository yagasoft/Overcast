...
import com.yagasoft.overcast.dropbox.authorisation.Authorisation;
import com.yagasoft.overcast.dropbox.transfer.DownloadJob;
import com.yagasoft.overcast.dropbox.transfer.Downloader;
import com.yagasoft.overcast.dropbox.transfer.IProgressListener;
import com.yagasoft.overcast.dropbox.transfer.UploadJob;
import com.yagasoft.overcast.dropbox.transfer.Uploader;
...
public class Dropbox extends CSP<DbxEntry.File, Downloader, Uploader> implements IProgressListener
{
	...
	/**
	 * @see com.yagasoft.overcast.dropbox.transfer.IProgressListener#progressChanged(com.yagasoft.overcast.dropbox.transfer.UploadJob,
	...
	/**
	 * @see com.yagasoft.overcast.CSP#getAbstractFactory()
	 */
	@Override
